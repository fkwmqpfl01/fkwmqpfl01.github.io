...
| --- | --- | --- | --- | --- |
| 1 | 처리 속도 | 느림 | 빠름 | YOLO의 인식, 분류 동시 수행 |
| 2 | 정확성 | 낮음 | 높음 | YOLO의 낮은 배경 오류 |
| 3 | 지역화 정확도 | 높음 | 낮음 | Fast R-CNN : 8.6%, YOLO : 19.0% |
| 4 | 배경 정확도 | 낮음 | 높음 | Fast R-CNN : 13.6%, YOLO : 4.75% |
| 5 | 겸쳐진 물체 판별 가능성 | 높음 | 낮음 | YOLO의 이미지 인식 방식 |
| 6 | 디테일 정도 | 높음 | 낮음 | YOLO의 Down Sampling 사용 |
