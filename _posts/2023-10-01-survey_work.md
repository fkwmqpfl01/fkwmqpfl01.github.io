...
<br><img src = "../images/table1.png"  width="80%" height="60%"></center>
...
<center><br><span style="font-size: 85%">Table 2. YOLO 알고리즘 적용 및 좌표계 변환 후 탐지된 객체 위치 비교 결과<a href="#footnote_5">5</a></span><br><img src = "../images/YOLOv4_result.png" width="50%" height="60%"></center>
...
<center><br><span style="font-size: 85%">Table 3. 검출기의 성능 비교<a href="#footnote_8">8</a></span><br><img src = "../images/compare_CNN_YOLO.png" width="70%" height="60%"></center>
