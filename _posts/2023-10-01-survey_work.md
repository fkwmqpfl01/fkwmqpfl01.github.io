...
<center><img src = "../images/C-ITS.png" width="70%" height="40%"><br><span style="font-size: 85%">Figure1. C-ITS 시스템의 구성</span></center>
...
<center><br><span style="font-size: 85%">Table 2. YOLO 알고리즘 적용 및 좌표계 변환 후 탐지된 객체 위치 비교 결과</span><br><img src = "../images/YOLOv4_result.png" width="50%" height="60%"></center>
...
&emsp; &emsp; &emsp;&emsp;<span style="font-size: 85%">Figure 2. 객체 검출 모델의 성능 비교</span>
&emsp; &emsp; &emsp;&emsp;&emsp;<span style="font-size: 85%">Figure 3. 객체 검출 모델의 추론 시간 비교</span>
...
<center><br><img src = "../images/CNN_YOLO_error.png" width="70%" height="60%">
<span style="font-size: 85%"><br>Figure 4. 오류 분석 : Fast R-CNN VS YOLO </span></center>
...
|&nbsp; 2&nbsp; | 정확성 | &emsp; 낮음 &emsp; |  높음  | YOLO의 낮은 배경 오류 |
|&nbsp; 3&nbsp; | 지역화 정확도 | &emsp; 높음 &emsp; |  낮음  | Fast R-CNN : 8.6%, YOLO : 19.0% |
|&nbsp; 4&nbsp; | 배경 정확도 | &emsp; 낮음  &emsp;|  높음  | Fast R-CNN : 13.6%, YOLO : 4.75% |
|&nbsp; 5&nbsp; | &nbsp;겹쳐진 물체 판별 가능성&nbsp; &nbsp;|  높음  |  낮음  | YOLO의 이미지 인식 방식 |
|&nbsp; 6&nbsp; | 디테일 정도 | &emsp; 높음 &emsp; |  낮음  | YOLO의 Down Sampling 사용 |
